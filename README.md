...
> [!NOTE]
> **Disclaimer**: ShelfLife is an independent, community-developed companion application. It is not affiliated with, endorsed by, or officially connected to the [Audiobookshelf](https://www.audiobookshelf.org/) project.
...
## ⚙️ Quick Start (Local Run, as development server only)
...
ShelfLife is an independent, community-developed companion application. It is not affiliated with, endorsed by, or officially connected to the [Audiobookshelf](https://www.audiobookshelf.org/) project.
